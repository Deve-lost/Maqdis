...
@section('title', 'Data Pembayaran Terverifikasi')
...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Pembayaran Terverifikasi</li>
        </ol>
        <!-- DataTables Example -->
        <div class="card mb-3">
...
@section('footer')
    <script type="text/javascript">
        $('.delete').click(function(){
            ...
            swal({
                  title: "Hapus!",
                  text: "Data Pembayaran "+peserta_nm+"?",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
                })
                .then((willDelete) => {
                  if (willDelete) {
                    window.location = "/Maqdis/destroy/"+peserta_id+"/pembayaran-terverifikasi";
                  }
                });
        });
    </script>
